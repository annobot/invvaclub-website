...
import { HeroActivities } from "./HeroActivities";
...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-bg px-4 pb-10 pt-24 sm:px-8 sm:pb-14 sm:pt-28 md:pb-16">
      <div className="container-narrow relative lg:grid lg:grid-cols-[1fr_26rem] lg:items-center lg:gap-6">
        <div className="relative z-[1]">
          <h1 className="font-display mb-2 text-[2.15rem] font-bold leading-[1.05] tracking-tight sm:mb-3 sm:text-5xl md:text-6xl lg:text-8xl [perspective:600px]">
          ...
          <motion.p
            className="mb-6 hidden max-w-xl text-sm leading-relaxed text-muted sm:mb-8 sm:text-lg lg:block"
